(custom-set-variables
 ...
 '(package-selected-packages
   '(smerge ivy-hydra use-package-hydra flycheck-posframe ivy-posframe major-mode-hydra highlight-symbol exwm kubernetes highlight-indent-guides json-mode fira-code highlight-thing highlight column-enforce-mode fancy-battery tide flycheck company persistent-scratch spaceline which-key dumb-jump counsel-projectile yaml-mode markdown-mode go-mode csharp-mode php-mode js2-refactor js2-mode smartparens git-gutter-fringe git-gutter hydra rainbow-delimiters volatile-highlights beacon auto-dim-other-buffers ivy magit xterm-color projectile default-text-scale auto-package-update exec-path-from-shell use-package auto-compile))
...
(custom-set-faces
 ...
 '(flycheck-error ((t (:background "#552255" :box (:line-width -1 :color "#882288")))))
 ...
 '(flycheck-info ((t (:background "#333333" :box (:line-width -1 :color "#666666")))))
 '(flycheck-warning ((t (:background "#222255" :box (:line-width -1 :color "#222288")))))
